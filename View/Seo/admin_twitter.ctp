...
echo $form->create('Settings', array('url' => array('plugin' => 'seo', 'controller' => 'seo', 'action' => 'twitter', 'admin' => true)));

	echo $form->input('Seo.twitter_username.id', array('type' => 'hidden', 'default' => $inputs['twitter_username']['id'] ));
	echo $form->input('Seo.twitter_consumer_key.id', array('type' => 'hidden', 'default' => $inputs['twitter_consumer_key']['id'] ));
	echo $form->input('Seo.twitter_consumer_secret.id', array('type' => 'hidden', 'default' => $inputs['twitter_consumer_secret']['id'] ));
	echo $form->input('Seo.twitter_access_token.id', array('type' => 'hidden', 'default' => $inputs['twitter_access_token']['id'] ));
	echo $form->input('Seo.twitter_access_token_secret.id', array('type' => 'hidden', 'default' => $inputs['twitter_access_token_secret']['id'] ));
